...
<div id="slide1">
	<div class="slide1_menu" onclick="closeSlide()">
		...
		<button id="menu_btn" class="wid-10">
			<i class="fa-solid fa-xmark fa-lg" style="color: #b7b7b7;"></i>
		</button>
	</div>
					...
					<div class="wid-55 hei-100 ">
						...
						<div class="wid-100 hei-30 flex">
							<div class="wid-10 hei-100 flex flex-ali-center">
								<img src="resources/img/${login_level}" alt="tier" class="wid-100 hei-40">
							</div>
	...
	<button id="write_btn" onclick="location.href='board_write.jsp'">글작성</button>
...
<div id="menu_bar"><!-- 메뉴 버튼-->
	...
	<div id="all_mini">
		...
		<c:forEach var="cate" items="${cate_list_mini }">
			<div
				onclick="scrollToCenter(this)" 
				<c:if test="${cate.name eq cate_name}">
					id="select_cate"
				</c:if>
			>
				<i class="${cate.mark}"></i>
